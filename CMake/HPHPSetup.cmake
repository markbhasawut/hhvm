...
if(APPLE)
  if (CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" OR CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "x86_64")
    message(STATUS "On macOS x86_64 platform.")
    if(EXISTS "/usr/local/")
      message(STATUS "Using Homebrew.")
      LIST (APPEND CMAKE_PREFIX_PATH "/usr/local")
      LIST (APPEND CMAKE_LIBRARY_PATH "/usr/local/lib/")
    elseif(EXISTS "/opt/local/var/macports/")
      message(STATUS "Using MacPorts.")
      LIST (APPEND CMAKE_PREFIX_PATH "/opt/local")
      LIST (APPEND CMAKE_LIBRARY_PATH "/opt/local/lib/x86_64")
    else()
      message(STATUS "Cannot find either Homebrew and MacPorts!")
      message(STATUS "Please install Homebrew or Macports!")
    endif()
  else()
    message(STATUS "On macOS ARM64 platform.")
